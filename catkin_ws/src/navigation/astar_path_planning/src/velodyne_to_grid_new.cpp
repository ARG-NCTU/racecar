...
Obstacle_Detection::Obstacle_Detection(ros::NodeHandle &n, ros::NodeHandle &pn):
  ...
  if(!pnh.getParam("lidar_frame", lidar_frame)) lidar_frame="base_link";
  ...
  /*kernel =  {
              ...
              {30, 40, 40, 40, 40, 40, 40, 40, 40, 40, 30},
              {30, 40, 50, 50, 50, 50, 50, 50, 50, 40, 30},
              {30, 40, 50, 60, 60, 60, 60, 60, 60, 40, 30},
              {30, 40, 50, 60, 100, 100, 100, 60, 50, 40, 30},
              {30, 40, 50, 60, 100, 100, 100, 60, 50, 40, 30},
              {30, 40, 50, 60, 100, 100, 100, 60, 50, 40, 30},
              {30, 40, 50, 60, 60, 60, 60, 60, 60, 40, 30},
              {30, 40, 50, 60, 60, 60, 60, 60, 50, 40, 30},
              {30, 40, 40, 40, 40, 40, 40, 40, 40, 40, 30},
              {30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30},
            };*/
  ...
  // Subscriber
  sub_cloud = pnh.subscribe("/racecar/velodyne1/velodyne_points", 1, &Obstacle_Detection::cbCloud, this);
}
